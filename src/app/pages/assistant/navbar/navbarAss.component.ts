    ...
    <div class="layout-container">
      <nav class="admin-navbar">
        <div class="nav-content">
          ...
          <div class="nav-menu">
            <a routerLink="/assistant/dashboard" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}" class="nav-link">
            ...
            <a routerLink="/assistant/Gestions" routerLinkActive="active" class="nav-link">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          <div class="nav-actions">
            <div class="user-menu">
              ...
              <div class="dropdown" [class.show]="isDropdownOpen">
                <a routerLink="/assistant/profile" class="dropdown-item" (click)="closeDropdown()">
...
export class NavbarAssComponent{
